...
Move::Move() {
    fromSq = nullptr;
    toSq = nullptr;
    fromPieceType = PieceTypes::UNKNOWN;
    fromPieceColour = Colour::UNKNOWN;
    captureMade = false;
    toPieceType = PieceTypes::UNKNOWN;
    toPieceColour = Colour::UNKNOWN;
    promotionType = PieceTypes::UNKNOWN;
    isCastle = false;
    castleRights = 0;
